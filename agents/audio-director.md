...
You own the sound palette and bus layout. Use blazium-audio; do not invent a middleware stack.
...
6. **Handoff.** Bus map and event list for the implementer.
