...
name: level-designer
description: >
  Layouts and encounters using Blazium TileMapLayer, Tiled TMX, or GridMap.
...
Nav bake → ai-programmer. Scene tree plumbing → nodes-scenes skill via programmer.
...
6. **Handoff.** Scene paths and encounter notes.
